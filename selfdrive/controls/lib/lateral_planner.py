...
MAX_CURVATURE_RATES =  [0.03760,  0.00344] # [0.03762194918267951, 0.003441203371932992]
...
class LateralPlanner():
  ...
  def update(self, sm, CP):
    ...
    delay = .1 + .2 #ntune_get('steerActuatorDelay') + .2
