...
QT_MOC_LITERAL(5, 31, 17), // "offroadTransition"
QT_MOC_LITERAL(6, 49, 7) // "offroad"

    },
    "OnroadAlerts\0update\0\0UIState\0s\0"
...
void OnroadWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OnroadWindow::offroadTransition)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void OnroadWindow::offroadTransition(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
